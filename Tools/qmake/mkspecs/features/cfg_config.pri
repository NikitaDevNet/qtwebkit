...
# See also in  # Dependences
    ...
    ENABLE_CFG_ARCHIVE=0 \  # =1
    ENABLE_CFG_CACHE=0 \  # =1
    ENABLE_CFG_FILTERS=0 \  # =1
...
contains(CFG_FEATURE_DEFAULTS, ENABLE_CFG_CONTEXT_MENUS=0) {
    CFG_FEATURE_DEFAULTS -= ENABLE_CONTEXT_MENUS=1
    CFG_FEATURE_DEFAULTS += ENABLE_CONTEXT_MENUS=0
}

contains(CFG_FEATURE_DEFAULTS, ENABLE_CFG_FILE_SYSTEM=0) {
    CFG_FEATURE_DEFAULTS -= ENABLE_FILE_SYSTEM=1
    CFG_FEATURE_DEFAULTS += ENABLE_FILE_SYSTEM=0
}

contains(CFG_FEATURE_DEFAULTS, ENABLE_CFG_GEOLOCATION=0) {
    CFG_FEATURE_DEFAULTS -= ENABLE_GEOLOCATION=1
    CFG_FEATURE_DEFAULTS += ENABLE_GEOLOCATION=0
}

contains(CFG_FEATURE_DEFAULTS, ENABLE_CFG_INDEXED_DATABASE=0) {
    CFG_FEATURE_DEFAULTS -= ENABLE_INDEXED_DATABASE=1
    CFG_FEATURE_DEFAULTS += ENABLE_INDEXED_DATABASE=0
}

contains(CFG_FEATURE_DEFAULTS, ENABLE_CFG_INPUT_SPEECH=0) {
    CFG_FEATURE_DEFAULTS -= ENABLE_INPUT_SPEECH=1
    CFG_FEATURE_DEFAULTS += ENABLE_INPUT_SPEECH=0
}

contains(CFG_FEATURE_DEFAULTS, ENABLE_CFG_INSPECTOR=0) {
    CFG_FEATURE_DEFAULTS -= ENABLE_INSPECTOR=1
    CFG_FEATURE_DEFAULTS += ENABLE_INSPECTOR=0
    CFG_FEATURE_DEFAULTS -= ENABLE_INSPECTOR_SERVER=1
    CFG_FEATURE_DEFAULTS += ENABLE_INSPECTOR_SERVER=0
    CFG_FEATURE_DEFAULTS -= ENABLE_JAVASCRIPT_DEBUGGER=1
    CFG_FEATURE_DEFAULTS += ENABLE_JAVASCRIPT_DEBUGGER=0
}

contains(CFG_FEATURE_DEFAULTS, ENABLE_CFG_MATHML=0) {
    CFG_FEATURE_DEFAULTS -= ENABLE_MATHML=1
    CFG_FEATURE_DEFAULTS += ENABLE_MATHML=0
}

contains(CFG_FEATURE_DEFAULTS, ENABLE_CFG_MEDIA_SOURCE=0) {
    CFG_FEATURE_DEFAULTS -= ENABLE_MEDIA_SOURCE=1
    CFG_FEATURE_DEFAULTS += ENABLE_MEDIA_SOURCE=0
    CFG_FEATURE_DEFAULTS -= ENABLE_MEDIA_STATISTICS=1
    CFG_FEATURE_DEFAULTS += ENABLE_MEDIA_STATISTICS=0
    CFG_FEATURE_DEFAULTS -= ENABLE_MEDIA_STREAM=1
    CFG_FEATURE_DEFAULTS += ENABLE_MEDIA_STREAM=0
    CFG_FEATURE_DEFAULTS -= ENABLE_RESOLUTION_MEDIA_QUERY=1
    CFG_FEATURE_DEFAULTS += ENABLE_RESOLUTION_MEDIA_QUERY=0
    CFG_FEATURE_DEFAULTS -= ENABLE_ENCRYPTED_MEDIA=1
    CFG_FEATURE_DEFAULTS += ENABLE_ENCRYPTED_MEDIA=0
    CFG_FEATURE_DEFAULTS -= ENABLE_ENCRYPTED_MEDIA_V2=1
    CFG_FEATURE_DEFAULTS += ENABLE_ENCRYPTED_MEDIA_V2=0
    CFG_FEATURE_DEFAULTS -= ENABLE_MEDIA_CAPTURE=1
    CFG_FEATURE_DEFAULTS += ENABLE_MEDIA_CAPTURE=0
}

contains(CFG_FEATURE_DEFAULTS, ENABLE_CFG_NAVIGATOR_CONTENT_UTILS=0) {
    CFG_FEATURE_DEFAULTS -= ENABLE_NAVIGATOR_CONTENT_UTILS=1
    CFG_FEATURE_DEFAULTS += ENABLE_NAVIGATOR_CONTENT_UTILS=0
}

contains(CFG_FEATURE_DEFAULTS, ENABLE_CFG_NOTIFICATIONS=0) {
    CFG_FEATURE_DEFAULTS -= ENABLE_NOTIFICATIONS=1
    CFG_FEATURE_DEFAULTS += ENABLE_NOTIFICATIONS=0
    CFG_FEATURE_DEFAULTS -= ENABLE_LEGACY_NOTIFICATIONS=1
    CFG_FEATURE_DEFAULTS += ENABLE_LEGACY_NOTIFICATIONS=0
}

contains(CFG_FEATURE_DEFAULTS, ENABLE_CFG_PROXIMITY_EVENTS=0) {
    CFG_FEATURE_DEFAULTS -= ENABLE_PROXIMITY_EVENTS=1
    CFG_FEATURE_DEFAULTS += ENABLE_PROXIMITY_EVENTS=0
}

contains(CFG_FEATURE_DEFAULTS, ENABLE_CFG_QUOTA=0) {
    CFG_FEATURE_DEFAULTS -= ENABLE_QUOTA=1
    CFG_FEATURE_DEFAULTS += ENABLE_QUOTA=0
}

contains(CFG_FEATURE_DEFAULTS, ENABLE_CFG_SQL_DATABASE=0) {
    CFG_FEATURE_DEFAULTS -= ENABLE_SQL_DATABASE=1
    CFG_FEATURE_DEFAULTS += ENABLE_SQL_DATABASE=0
}

contains(CFG_FEATURE_DEFAULTS, ENABLE_CFG_SVG=0) {
    CFG_FEATURE_DEFAULTS -= ENABLE_SVG=1
    CFG_FEATURE_DEFAULTS += ENABLE_SVG=0
    CFG_FEATURE_DEFAULTS -= ENABLE_SVG_FONTS=1
    CFG_FEATURE_DEFAULTS += ENABLE_SVG_FONTS=0
}

contains(CFG_FEATURE_DEFAULTS, ENABLE_CFG_WEB_AUDIO=0) {
    CFG_FEATURE_DEFAULTS -= ENABLE_WEB_AUDIO=1
    CFG_FEATURE_DEFAULTS += ENABLE_WEB_AUDIO=0
    CFG_FEATURE_DEFAULTS -= ENABLE_LEGACY_WEB_AUDIO=1
    CFG_FEATURE_DEFAULTS += ENABLE_LEGACY_WEB_AUDIO=0
}

contains(CFG_FEATURE_DEFAULTS, ENABLE_CFG_WEB_SOCKETS=0) {
    CFG_FEATURE_DEFAULTS -= ENABLE_WEB_SOCKETS=1
    CFG_FEATURE_DEFAULTS += ENABLE_WEB_SOCKETS=0
}

contains(CFG_FEATURE_DEFAULTS, ENABLE_CFG_WORKERS=0) {
    CFG_FEATURE_DEFAULTS -= ENABLE_WORKERS=1
    CFG_FEATURE_DEFAULTS += ENABLE_WORKERS=0
    CFG_FEATURE_DEFAULTS -= ENABLE_SHARED_WORKERS=1
    CFG_FEATURE_DEFAULTS += ENABLE_SHARED_WORKERS=0
}
